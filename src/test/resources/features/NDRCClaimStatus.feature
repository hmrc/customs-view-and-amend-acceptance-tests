...
Feature: Display backend claims status to in progress, pending and closed categories
  ...
  Scenario Outline: Display in-progress status for single declaration claims
    ...
    Then I should see the following claim details
      ...
      | MRN      | Local Reference Number (LRN)     | Claimant‘s EORI number | Claim type   | Claim status | Claim start date | Claim amount requested | Claimant‘s name | Claimant‘s email address |
  ...
  Scenario Outline: Display closed status for multiple declarations claims
    ...
    When I click on '<claim ref>'
    Then I should see the following claim details
      | Local Reference Number (LRN)     | Claimant‘s EORI number | Claim type   | Claim decision   | First MRN | Claim start date | Claim removal date | Claim amount requested | Claimant‘s name | Claimant‘s email address | Other MRNs included in this claim                                                 |
  ...
  Scenario Outline: Display closed status for single declaration claims
    ...
    When I click on '<claim ref1>'
    Then I should see the following claim details
      | MRN      | Local Reference Number (LRN)     | Claimant‘s EORI number | Claim type   | Claim decision   | Claim start date | Claim removal date | Claim amount requested | Claimant‘s name | Claimant‘s email address |
