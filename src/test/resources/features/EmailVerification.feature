...
Feature: Email Verification
  ...
  Scenario: User without a verified email address is redirected to email verification page
    ...
    Then I am redirected to the "You need to verify the registered CDS email address - View your customs financial accounts - GOV.UK" page
  ...
  Scenario: Display undeliverable email page
    ...
    When I navigate to the View and amend home page
    Then the page title should be "There's a problem with the CDS registered email address - View your customs financial accounts - GOV.UK"
