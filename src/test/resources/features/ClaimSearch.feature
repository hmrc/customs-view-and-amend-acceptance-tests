...
#    When I click on back link to previous page
  ...
  Scenario: Search closed claims using claim number
    ...
    And I should see the following claim details
      ...
      | MRN23014 | KWMREF1 | GB98745632101          | Overpayment (C285),Single declaration | 1 May 2020       | 1 May 2021         | Approved       | £900000.00             | Claimant name   | someemail@mail.com       |
  ...
  Scenario: Search pending claims using claim number
    ...
    And I should see the following claim details
      | LRN     | Claimant's EORI number | Claim type                                     | Claim status | First MRN | Claim start date | Claim amount requested | Claimant's name | Claimant's email address | Other MRNs included in this claim                                                          |
      | KWMREF1 | GB98745632101          | Rejected goods (C&E1179),Multiple declarations | Pending      | MRN23014  | 1 May 2020       | £900000.00             | Claimant name   | someemail@mail.com       | MRN00001,MRN00002,MRN00003,MRN00004,MRN00005,MRN00006,MRN00007,MRN00008,MRN00009,MRN000010 |
